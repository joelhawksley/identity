...
description: "TL;DR: Keep an internally public, daily journal of snippets describing the impact of your work, written with the intention of adding them to your performance review."
---
...
After receiving peer feedback that it wasn’t clear what I did as a staff engineer in my director’s organization, I began an experiment: I started keeping a daily, internally public work journal, riffing on Julia Evans’ [brag doc](https://jvns.ca/blog/brag-documents/) technique. The effect was immediate. My manager and several peers were quick to praise and appreciate the transparency, and a couple other folks started their own journals too.
...
Knowing I’m going to post something public to my colleagues at the end of every work day motivates me to do work _worth posting about_! It also serves as a point of reflection, forcing me to consider whether I used my time effectively, sparking conversations with my manager and peers about how to better allocate my time.
...
- “Paired with peer on a tricky problem, recommending a change to their workflow to cut down on cycle time”
- “Reviewed pull request, catching potential security issue”
- “Attended team meeting, driving conversation towards an actionable plan for the team next week”
